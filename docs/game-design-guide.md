...
- O catálogo histórico `2026.5` congela as 24 etapas do calendário original de 2026, incluindo Bahrain e Jeddah mesmo se o campeonato real for alterado durante a temporada. O runtime `2026.9` preserva nomes reais, traçados reconhecíveis e ambientes laterais auditados, remove landmarks provisórios dispersos e representa boxes, arquibancadas e construções principais com ilustrações originais; até a rodada futura de cenário temático, permanecem somente o fundo base e a infraestrutura necessária da pista.
