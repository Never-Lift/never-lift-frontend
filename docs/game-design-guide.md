...
- Curvas, asfalto, áreas externas, barreiras e grades derivam da mesma centerline métrica suavizada, amostrada a cada aproximadamente 5 m. Zebras são segmentos explícitos e autorais por curva, colocados além da borda do asfalto no lado interno e na saída conforme mapas e notas oficiais disponíveis, com largura, cadência, paleta e faixa pintada externa próprias. Pits, boxes, garagens, prédios e cercas usam dimensões métricas e não podem sobrepor asfalto, barreiras ou outra estrutura; a funcionalidade de parada continua reservada ao Módulo 5. Vias de escape especiais podem existir como camada visual métrica separada e declaradamente sem física; no Rettifilo de Monza, o corredor asfaltado externo e as fileiras alternadas de blocos de pedra reproduzem a rota lenta em zigue-zague. Essa é a exceção funcional do catálogo: os blocos e as bordas de concreto são colidíveis e usam a mesma geometria do renderer, sem criar colisores invisíveis sobre o circuito principal.
