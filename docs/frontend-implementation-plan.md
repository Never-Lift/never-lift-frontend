...
**Estado da entrega:** em andamento. A Parte 2a (motor) e as regras compartilhadas v1.2 de equidade dos carros, modo único da corrida, controles e dano cumulativo estão concluídas e foram validadas manualmente na preview. As Partes 2b (24 pistas e geometrias da API) e 2c (ambiente e polimento) permanecem pendentes. Este estado parcial não torna o Módulo 2 pronto.
