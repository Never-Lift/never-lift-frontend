...
**Estado da entrega:** em andamento. As Partes 2a, 2b e 2c e o catálogo `2026.5` passaram pela validação manual integrada em 24/08/2026. A simplificação para F1 único/condução única e o refinamento de câmera 2.5D/F1 multidirecional aguardam validação manual final no preview. Na Parte 2d, a implementação automatizada está concluída. A revisão de segurança visual `2026.12` das 24 pistas também está automatizada, com zebras autorais preservadas, faixas contínuas de muro/grade, placas completas por curva, pontas retas em Suzuka, largada de Silverstone reposicionada e Marina Bay orientada no sentido anti-horário, entradas/saídas navegáveis do pit e 22 vãos opacos de garagem por circuito com face traseira colidível; o escape provisório do Rettifilo de Monza foi removido; a Parte 2d e o Módulo 2 não estão prontos.
