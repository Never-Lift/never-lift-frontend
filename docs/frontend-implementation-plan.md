...
**Refinamento visual implementado:** a câmera deixa de usar uma projeção ortográfica uniforme e passa a aplicar uma perspectiva 2.5D fixa, comprimindo a profundidade sem alterar coordenadas, física, colisões ou contratos. Sua orientação depende somente do vetor de movimento, com retenção em baixa velocidade, atraso inicial em inversão sustentada e limite de giro por frame. O F1 provisório foi substituído por um modelo Canvas original e multidirecional, quantizado em 32 vistas relativas a cada câmera, com frente, traseira, laterais, pneus, suspensão, asas, cockpit, capacete e halo completos. Pista, zebras, barreiras, grades, marcas de pneu e ordenação dos carros usam a mesma projeção; split-screen continua com uma câmera independente por jogador.
