...
**Estado da entrega:** pronto. A Parte 2a está concluída e validada. A Parte 2b recebeu correções para limites segmentados, bots em curvas estreitas e câmera em ré e foi revalidada manualmente em 21/08/2026 com o atlas integral e os 24 circuitos carregados e iniciados pela API real. A Parte 2c concluiu ambiente, iluminação e largada; a validação manual final de 24/08/2026 confirmou solo e split-screen local, os três presets de horário, a passagem inferior de Suzuka e a continuidade dos faróis entre chunks.
...
**Parte 2c entregue:** semáforo de cinco luzes; detecção de largada queimada com bloqueio temporário do acelerador; presets fixos de dia, entardecer e noite; iluminação noturna e faróis recortados por viewport, chunks e camadas elevadas; ambiente estático e partículas determinísticas limitadas pela qualidade gráfica. Alertas visuais completos de dano continuam reservados ao Módulo 5, conforme o guia de design.
