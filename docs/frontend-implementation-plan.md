...
**Estado da entrega:** em andamento. A Parte 2a (motor) está implementada; as regras compartilhadas v1.2 de equidade dos carros, modo único da corrida, controles e dano cumulativo aguardam revalidação manual na preview. As Partes 2b (24 pistas e geometrias da API) e 2c (ambiente e polimento) permanecem pendentes. Este estado parcial não torna o Módulo 2 pronto.
