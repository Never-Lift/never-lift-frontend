...
| 3 — Motor autoritativo online | Parte 3a (sala, ticket e lobby, incluindo refinamento de acesso/configuração de 02/09/2026) implementada; nova validação manual em dois navegadores pendente; 3b (motor físico) e 3c (classificação e fluxo de corrida) pendentes |
