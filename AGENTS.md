...
| 2 — Motor de corrida local | em andamento — Parte 2a concluída e validada manualmente com as regras v1.2 de equidade, controles e dano cumulativo; Partes 2b (pistas) e 2c (ambiente/polimento) pendentes |
