...
- A câmera acompanha a posição e exclusivamente a direção do movimento com suavização de `0,25s`; o ângulo da carroceria não interfere na orientação. A projeção 2.5D comprime a profundidade do solo para mostrar principalmente o teto e uma pequena parte das laterais, enquadra o carro em aproximadamente 60% da altura e mantém o comprimento visual em 5,5%, abaixo do limite de 6%. Paradas preservam a última orientação e uma inversão sustentada segura a câmera por `0,4s` antes da convergência suave. O minimapa usa as mesmas coordenadas do mundo e nunca gira.
- O F1 original é desenhado em 32 direções relativas a cada câmera, com bico, asas, pneus expostos, suspensão, cockpit, capacete e halo visíveis conforme o ângulo. A pintura selecionada continua sendo a única diferença competitivamente neutra entre os carros; a prévia usa o mesmo modelo com detalhe adicional.
