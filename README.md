...
- `/race` abre a preparação do `RaceEngine`, com as 24 pistas do catálogo `2026.9`, prévia do traçado, país, comprimento e ambiente, além do F1 único e sua paleta de pinturas predefinidas.
...
A preparação técnica do Módulo 2 está em [`docs/contracts/module-2-shared-contracts.md`](docs/contracts/module-2-shared-contracts.md), na [proposta aprovada da física v2](docs/contracts/module-2-physics-v2-proposal.md), no [relatório de fidelidade visual das pistas](docs/module-2-track-visual-audit-2026.9.md) e em [`contracts/module-2/v2/`](contracts/module-2/v2/). O `v1` preserva o catálogo `2026.5` e a física `1.3.0` como histórico imutável; o runtime atual usa a linha `v2`, catálogo `2026.9` e física `2.0.0`. O frontend mantém somente a pista selecionada em memória; as 24 geometrias completas pertencem ao backend e chegam pela API.
