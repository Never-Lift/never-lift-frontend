...
As Partes 2a, 2b e 2c e o catálogo `2026.5` passaram pela validação manual integrada em 24/08/2026. A simplificação posterior para F1 único/condução fixa e os refinamentos de câmera 2.5D/F1 ainda exigem validação manual final. Na Parte 2d, a implementação automatizada está concluída. O catálogo `2026.10` preserva as revisões anteriores e acrescenta muros e grades com junções contínuas, placas regressivas de frenagem ampliadas no renderer, pontas retas na estrutura transparente de Suzuka e uma abertura física/visual única para a via de escape reta do Rettifilo, com blocos brancos/chevrons vermelhos e muro somente na borda externa. Boxes e arquibancadas não foram reabertos nesta rodada. A validação manual permanece pendente; por isso a Parte 2d e o Módulo 2 continuam em andamento e o Módulo 3 ainda não deve começar.
